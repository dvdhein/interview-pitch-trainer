...
type Language = "en" | "pt";
type PracticeItem = { id: string; title: string; en: string; pt: string; tag?: string };
...
const pitches: PracticeItem[] = [
  {
    ...
    en: "Throughout my 22-year career, a big part of my role is building solid enterprise architectures and protecting vital company assets. I've spent a lot of time in banking, healthcare, and retail — environments where security and uptime can make or break the business. I have strong skills and experience in securing modern platforms and enforcing industry standards like NIST and ISO 27001. My philosophy is simple: security should never get in the way of shipping products. I know how to turn policies into code and automated guardrails, so engineering teams can move fast with confidence. What sets me apart is that I am always ready to jump into complex challenges and lead teams through change. I bring technical depth, clear communication, and dependable leadership to your team.",
    pt: "Ao longo dos meus 22 anos de carreira, uma grande parte do meu papel é construir arquiteturas sólidas e proteger os ativos mais importantes da empresa. Atuei muito em bancos, saúde e varejo — setores onde segurança e disponibilidade são fundamentais para o negócio. Tenho sólidas habilidades e experiência em proteger plataformas modernas e fazer cumprir normas como NIST e ISO 27001. Minha visão é prática: segurança não deve travar entregas. Eu sei como transformar políticas em código e guardrails automáticos, permitindo que a engenharia entregue rápido e com segurança. O que me diferencia é que estou sempre pronto para encarar desafios complexos e guiar o time em momentos de mudança. Trago bagagem técnica sólida, facilidade de diálogo e liderança confiável.",
  },
  {
    id: "technical",
    tag: "ARCHITECTURE PANEL",
    title: "Technical solutions architect",
    en: "In my work as a solutions architect, a big part of my role is making sure our security directly supports business growth instead of blocking it. I am good at designing end-to-end architectures that keep systems safe while keeping developer velocity high. Over the years, I've learned how to enforce baseline security policies by working side-by-side with developers and cloud engineers. One of my strongest assets is taking high-level business risks and turning them into simple, concrete technical designs that protect data. What sets me apart is my ability to stay ahead of new technologies. I am always ready to solve hard problems and deliver real value.",
    pt: "No meu trabalho com arquitetura de soluções, uma grande parte do meu papel é garantir que a segurança ajude o negócio a crescer, em vez de ser um obstáculo. Sou muito bom em desenhar arquiteturas completas que protegem os sistemas e mantêm a velocidade dos desenvolvedores alta. Com o tempo, aprendi a aplicar boas práticas de segurança trabalhando lado a lado com os times de desenvolvimento e nuvem. Um dos meus maiores diferenciais é pegar riscos complexos de negócio e traduzir isso em soluções técnicas diretas que protegem nossos dados. O que me diferencia é minha capacidade de me manter à frente das novas tecnologias. Estou sempre pronto para resolver problemas difíceis e gerar valor real.",
  },
  {
    id: "ai",
    tag: "AI-FIRST ROLE",
    title: "AI security & modernization",
    en: "Right now, a big part of my role is bridging traditional cybersecurity with Artificial Intelligence. I have strong skills and experience in building secure pipelines for Large Language Models and protecting company data assets from leaks and emerging AI risks. I know how to enforce practical guardrails using tools like LangChain, Ollama, and Azure AI. At Aché, for example, I've learned how to build an AI copilot that automatically reviews architecture decision records. What sets me apart is combining real, hands-on AI work with over 20 years of enterprise architecture experience. I am always ready to help companies adopt AI safely.",
    pt: "Hoje, uma grande parte do meu papel é conectar a segurança da informação à Inteligência Artificial. Tenho sólidas habilidades e experiência em construir esteiras seguras para modelos de IA e proteger os ativos e dados da empresa contra vazamentos e novos riscos de IA. Eu sei como aplicar guardrails práticos usando ferramentas como LangChain, Ollama e Azure AI. Na Aché, por exemplo, aprendi a construir um copiloto de IA que revisa automaticamente documentos de arquitetura. O que me diferencia é juntar a prática direta com IA a mais de 20 anos de vivência em grandes empresas. Estou sempre pronto para ajudar o time a adotar IA com segurança.",
  },
];

const qa: PracticeItem[] = [
  { id: "q1", title: "What are your biggest strengths and your working style?", en: "One of my strongest assets is taking full ownership from start to finish. I am good at building trust with engineering teams so that security standards are adopted naturally and enforced without friction. My working style is practical, collaborative, and calm under pressure — I am always ready to dig in, solve the root cause, and make sure issues don't come back.", pt: "Um dos meus maiores diferenciais é assumir o compromisso de ponta a ponta. Sou muito bom em construir pontes com os desenvolvedores, fazendo com que as regras de segurança sejam aplicadas com naturalidade e sem atrito. Meu estilo de trabalho é prático, parceiro e tranquilo sob pressão — estou sempre pronto para arregaçar as mangas, resolver a raiz do problema e evitar retrabalho." },
  { id: "q2", title: "Why are you a strong candidate for this position?", en: "I have strong skills and experience in securing hybrid cloud environments and protecting sensitive enterprise assets. I know how to take complex regulations — like BACEN, PCI, or ISO 27001 — and turn them into clear, sensible technical steps that developers can easily implement.", pt: "Tenho sólidas habilidades e experiência em proteger ambientes em nuvem e ativos de dados sensíveis. Eu sei como pegar normas cheias de detalhes — como BACEN, PCI ou ISO 27001 — e traduzi-las em passos simples e viáveis para quem está programando." },
  { id: "q3", title: "How do you approach innovation and AI?", en: "A big part of my approach is using technology where it actually solves a real problem. I've learned how to build tools like AI review copilots and automated policy checks that save people hours of manual work. What sets me apart is my ability to experiment and innovate fast, while keeping corporate data strictly protected.", pt: "Uma grande parte da minha abordagem é usar tecnologia onde ela realmente resolve uma dor do dia a dia. Aprendi a criar ferramentas como copilotos de IA e validações automáticas que poupam horas de trabalho manual. O que me diferencia é minha capacidade de inovar com agilidade, mantendo os dados da empresa totalmente protegidos." },
    ...
    <div className="min-h-screen bg-[#f5f0e7] text-[#292827]">
      ...
      <header className="sticky top-0 z-30 border-b border-[#292827]/10 bg-[#f5f0e7]/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-[1440px] items-center justify-between px-5 py-4 lg:px-10">
          <button onClick={() => goSection("pitches")} className="group flex items-center gap-3 text-left" aria-label="Ir para início">
            <img src="/manus-storage/pitch-mark_8ce53f32.png" alt="" className="h-10 w-10 object-contain" />
          ...
          <div className="flex items-center gap-2">
            <div className="hidden items-center rounded-full border border-[#292827]/15 p-1 sm:flex" aria-label="Idioma">
              <button onClick={() => setLanguage("en")} className={`lang-btn ${language === 'en' ? 'lang-active' : ''}`}>EN</button>
              <button onClick={() => setLanguage("pt")} className={`lang-btn ${language === 'pt' ? 'lang-active' : ''}`}>PT</button>
            </div>
      ...
      <main className="mx-auto max-w-[1440px] px-5 pb-20 lg:px-10">
        <section className="hero-grid relative overflow-hidden border-b border-[#292827]/10 py-14 lg:py-24">
          <img src="/manus-storage/rehearsal-paper-texture_5a2d9204.png" alt="" className="pointer-events-none absolute inset-0 h-full w-full object-cover opacity-30 mix-blend-multiply" />
...
function SkillMap() {
  return <div><div className="eyebrow">03 / SKILL MAP</div><h2 className="mt-3 max-w-2xl font-serif text-5xl tracking-[-0.04em]">Sua experiência, organizada para aparecer.</h2><p className="mt-6 max-w-2xl text-base leading-7 text-[#292827]/65">Use esta lista como mapa mental. Em uma conversa, escolha dois ou três domínios e conecte-os a uma história prática.</p><div className="mt-10 grid gap-3 sm:grid-cols-2">{skills.map((skill, i) => <div key={skill} className="skill-card"><span className="font-serif text-3xl text-[#d96c4f]/70">0{i + 1}</span><span><strong>{skill}</strong><small>{i % 2 === 0 ? 'Arquitetura · proteção · decisão' : 'Prática · colaboração · evolução'}</small></span></div>)}</div><div className="mt-10 rounded-[2px] bg-[#292827] p-7 text-[#f5f0e7] sm:p-10"><div className="eyebrow text-[#f5f0e7]/50">FRASE DE TRANSIÇÃO</div><p className="mt-4 max-w-2xl font-serif text-3xl leading-tight">“A big part of my role is connecting this technical depth to a business outcome.”</p></div></div>;
}

function CoachNotes() {
  return <div><div className="eyebrow">04 / COACH NOTES</div><h2 className="mt-3 max-w-2xl font-serif text-5xl tracking-[-0.04em]">Não decore. Encontre o ritmo.</h2><div className="mt-10 grid gap-4 sm:grid-cols-3">{[['01','Guarde a sequência','Contexto → habilidade prática → diferencial.'],['02','Respire nas pausas','Uma pausa de um segundo depois de uma conquista importante.'],['03','Fale como colega','Caloroso, confiante e colaborativo — sem soar como um livro técnico.']].map(([n,t,d]) => <div key={n} className="coach-card"><span className="font-serif text-5xl text-[#d96c4f]">{n}</span><h3 className="mt-12 text-base font-extrabold">{t}</h3><p className="mt-3 text-sm leading-6 text-[#292827]/60">{d}</p></div>)}</div><div className="mt-8 flex items-center gap-3 border-y border-[#292827]/10 py-5 text-sm font-bold"><RotateCcw size={17} className="text-[#d96c4f]" /> Dica: faça uma tentativa sem olhar e só depois revise as palavras-chave.</div></div>;
}
